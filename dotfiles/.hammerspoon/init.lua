...
local function correct_spaces(displays_indexes, spaces_indexes, callback)
  utils.sequential(space_assignments, function(space_assignment, next)
    ...
    local space_indexes = spaces_indexes[space_label]
...
purge_empty_spaces(function()
  ...
  get_displays_indexes(my_displays, function(displays_indexes)
    get_spaces_labels_indexes(function(spaces_indexes)
      correct_spaces(displays_indexes, spaces_indexes, function()
...
hs.notify.show("", "", "reloaded config")
