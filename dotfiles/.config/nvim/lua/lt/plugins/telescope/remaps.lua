...
r.noremap("n", "<leader>sl", builtin.live_grep, "Live grep")
r.noremap("n", "<leader>sL", functions.live_grep_in_folder, "Live grep in folder")
r.noremap("n", "<leader>sc", functions.search_config, "Search neovim config")
...
r.noremap("n", "<leader>/k", builtin.keymaps, "Search keymaps")
